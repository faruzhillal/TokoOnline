    ...
    <div class="col-md-12">
        <div class=" billing-details">
            ...
            <div class="row">
                ...
                <form action="{{ route('customer.updateakun', $edit->user->id) }}" method="post"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <img src="{{ asset('storage/img-customer/' . $userData->foto) }}" class="foto-preview"
                                width="100%">
                            @else
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pos" value="{{ old('pos', $edit->pos)}}"
                                ...
                                placeholder="Masukkan NomorResi">
                            @error('pos')
                            <span class="invalid-feedback alert-danger" role="alert">
                                {{ $message }}
                            </span>
