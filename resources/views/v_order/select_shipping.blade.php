        ...
        fetch('/provinces')
            ...
            .then(data => {
                if (data.rajaongkir && data.rajaongkir.status.code === 200) {
                    ...
                    console.error('Failed to fetch provinces', data.rajaongkir ? data.rajaongkir.status
                        .description : 'No data');
                    alert('Gagal memuat data provinsi: ' + (data.rajaongkir ? data.rajaongkir.status
                ...
                .then(data => {
                    if (data.rajaongkir && data.rajaongkir.status.code === 200) {
                        ...
                        citySelect.innerHTML =
                            '<option value="">Pilih Kota Tujuan</option>'; // Clear previous options
                        cities.forEach(city => {
                            let option = document.createElement('option');
                        ...
                        console.error('Failed to fetch cities', data.rajaongkir ? data.rajaongkir.status
                            .description : 'No data');
                        alert('Gagal memuat data kota: ' + (data.rajaongkir ? data.rajaongkir.status
                            .description : 'Tidak ada data'));
                    }
                })
                .catch(error => {
